...
/* Nombre de modèles de secours tirés du catalogue. Au-delà, l'attente devient
   plus pénible que l'échec : chaque tentative coûte un aller-retour. */
const MAX_SECOURS = 4;
...
async function callModel(apiKey, model, prompt, parts) {
  ...
  if (!response.ok) {
    ...
    // 401/403 = clé rejetée : changer de modèle n'y changerait rien. Les deux
